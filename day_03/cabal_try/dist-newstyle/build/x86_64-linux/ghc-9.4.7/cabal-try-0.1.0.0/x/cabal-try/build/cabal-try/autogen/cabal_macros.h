...
/* package cabal-try-0.1.0.0 */
#ifndef VERSION_cabal_try
#define VERSION_cabal_try "0.1.0.0"
#endif /* VERSION_cabal_try */
#ifndef MIN_VERSION_cabal_try
#define MIN_VERSION_cabal_try(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_cabal_try */
...
#define CURRENT_COMPONENT_ID "cabal-try-0.1.0.0-inplace-cabal-try"
